  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-gray-500">Lacak kesehatan hukum perusahaan dan daftar periksa kepatuhan.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="md:col-span-1 bg-brand-900 text-white border-0 overflow-hidden relative">
          ...
          <CardContent className="p-6 relative z-10">
            <p className="text-brand-100 font-medium">Skor Kesehatan Hukum Keseluruhan</p>
            ...
            <p className="text-sm text-emerald-400 mt-2 font-medium flex items-center">
              <CheckCircle className="w-4 h-4 mr-1" /> Status Sangat Baik
            </p>
        ...
        <Card className="md:col-span-2">
          <CardHeader>
            <CardTitle>Tindakan Kepatuhan yang Diperlukan</CardTitle>
            <CardDescription>Tugas yang memerlukan perhatian segera untuk menjaga kepatuhan hukum.</CardDescription>
          </CardHeader>
          <CardContent>
             <div className="space-y-4">
                <div className="p-4 border border-red-100 bg-red-50 rounded-xl flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-red-900">Data BPJS Karyawan Belum Lengkap</h4>
                    <p className="text-sm text-red-700 mt-1">3 karyawan belum melengkapi dokumen pendaftaran BPJS wajib.</p>
                  </div>
                  <Button variant="outline" size="sm" className="bg-white">Tinjau</Button>
                </div>
                ...
                <div className="p-4 border border-amber-100 bg-amber-50 rounded-xl flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-amber-900">Izin Vendor Segera Kedaluwarsa</h4>
                    <p className="text-sm text-amber-700 mt-1">Izin operasional PT Teknologi Bersama akan habis dalam 14 hari.</p>
                  </div>
                  <Button variant="outline" size="sm" className="bg-white">Tinjau</Button>
                </div>
             </div>
